...
<div class="container-fluid">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h1 class="h3 mb-0 text-body">Editar Cliente</h1>
        ...
        <div class="card-body p-4">
            <form method="POST" action="{{ route('clientes.update',$cliente) }}" id="formCliente" novalidate class="row g-3">
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" class="form-control rounded-pill bg-secondary bg-opacity-10 border-0 text-body" name="nombre" id="nombre" value="{{ old('nombre',$cliente->nombre) }}" required pattern="[a-zA-ZñÑáéíóúÁÉÍÓÚ\s]+" title="Solo letras y espacios">
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" class="form-control rounded-pill bg-secondary bg-opacity-10 border-0 text-body" name="apellido" id="apellido" value="{{ old('apellido',$cliente->apellido) }}" required pattern="[a-zA-ZñÑáéíóúÁÉÍÓÚ\s]+" title="Solo letras y espacios">
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" class="form-control rounded-pill bg-secondary bg-opacity-10 border-0 text-body" name="documento" id="documento" value="{{ old('documento',$cliente->documento) }}" required pattern="[0-9.\-\s]+" title="Solo números, puntos, guiones y espacios">
                ...
                <div class="col-md-6">
                    ...
                    <input type="tel" class="form-control rounded-pill bg-secondary bg-opacity-10 border-0 text-body" name="telefono" id="telefono" value="{{ old('telefono',$cliente->telefono) }}" pattern="[0-9+\-\s]+" title="Solo números, espacios, + y -">
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" class="form-control rounded-pill bg-secondary bg-opacity-10 border-0 text-body" name="direccion" id="direccion" value="{{ old('direccion',$cliente->direccion) }}" maxlength="200">
                    @error('direccion')<div class="text-danger small ms-2 mt-1">{{ $message }}</div>@enderror
                </div>
                <div class="col-md-6">
                    <label class="form-label fw-bold small text-muted">Email</label>
                    <input type="email" class="form-control rounded-pill bg-secondary bg-opacity-10 border-0 text-body" name="email" id="email" value="{{ old('email',$cliente->email) }}">
