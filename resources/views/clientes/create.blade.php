    ...
    <div class="glass-card">
        ...
        <div class="card-body p-4">
            <form method="POST" action="{{ route('clientes.store') }}" id="formCliente" novalidate class="row g-3">
                ...
                <div class="col-12 mt-4 d-flex flex-column-reverse flex-md-row justify-content-md-end gap-2">
                    <a href="{{ route('clientes.index') }}" class="btn btn-outline-light rounded-pill px-4 hover-scale text-center">Cancelar</a>
                    <button type="submit" class="btn btn-primary rounded-pill px-4 shadow-sm hover-scale text-center">
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        // Validación de Teléfono (Solo números y símbolos permitidos)
