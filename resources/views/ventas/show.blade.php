            ...
            <div class="row g-4 mb-4">
                <div class="col-md-8">
                    <div class="glass-card border-0 shadow-lg rounded-4 overflow-hidden h-100">
                        <div class="card-header bg-transparent border-bottom border-light border-opacity-10 py-3">
                            <h5 class="mb-0 fw-bold text-body"><i class="bi bi-cart-check me-2 text-primary"></i>Detalle de Productos</h5>
                        </div>
                                        ...
                                        <tr class="hover-bg-white-10 transition-all">
                                            <td class="ps-4 border-bottom border-light border-opacity-10">
                                                <div class="d-flex align-items-center gap-3">
                                                    ...
                                                    @else
                                                        <div class="bg-secondary bg-opacity-10 rounded-3 d-flex align-items-center justify-content-center shadow-sm text-muted small" style="width:48px;height:48px">
                                            ...
                                            <td class="text-center border-bottom border-light border-opacity-10">
                                                <span class="badge bg-secondary bg-opacity-10 text-body border border-secondary border-opacity-25 rounded-pill px-3">{{ $d->cantidad }}</span>
                                            </td>
                                            <td class="text-end fw-bold text-muted border-bottom border-light border-opacity-10">{{ $configuracion['moneda'] ?? '$' }} {{ number_format($d->precio_unitario,2) }}</td>
                ...
                <div class="col-md-4">
                    <div class="glass-card border-0 shadow-lg rounded-4 overflow-hidden mb-4">
                        <div class="card-header bg-transparent border-bottom border-light border-opacity-10 py-3">
                            <h5 class="mb-0 fw-bold text-body"><i class="bi bi-info-circle me-2 text-primary"></i>Información</h5>
                        </div>
                        <div class="card-body p-4">
                            <div class="mb-4">
                                ...
                                <div class="d-flex align-items-center p-3 rounded-4 border border-light border-opacity-10 bg-secondary bg-opacity-10">
                                    ...
                                    <div>
                                        <p class="fw-bold text-body mb-0">{{ $venta->cliente->nombre ?? '-' }}</p>
                            ...
                            <div class="mb-4">
                                <label class="small text-muted text-uppercase fw-bold mb-1">Vendedor</label>
                                <div class="d-flex align-items-center p-3 bg-secondary bg-opacity-10 rounded-4 border border-light border-opacity-10">
                                    ...
                                    <p class="fw-bold text-body mb-0">{{ $venta->usuario->nombre ?? '-' }}</p>
                                </div>
                            </div>
                            ...
                            <div>
                                ...
                                <div class="p-2 border border-light border-opacity-10 rounded-pill text-center bg-secondary bg-opacity-10 text-muted">
