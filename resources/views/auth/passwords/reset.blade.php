    ...
    <div class="glass-card w-100 auth-card overflow-hidden">
        <div class="card-body p-4 p-md-5">
            <div class="text-center mb-4">
                ...
                <h4 class="fw-bold text-body">Nueva Contraseña</h4>
            ...
            <form method="POST" action="{{ route('password.update') }}">
                ...
                <div class="mb-3">
                    ...
                    <div class="input-group">
                        ...
                        <input type="email" name="email" class="form-control border-0 bg-secondary bg-opacity-10 text-body rounded-end-pill border-light border-opacity-10" value="{{ $email ?? old('email') }}" required autofocus placeholder="nombre@ejemplo.com">
                    </div>
                ...
                <div class="mb-4">
                    ...
                    <div class="input-group">
                        <span class="input-group-text border-0 bg-secondary bg-opacity-10 ps-3 text-primary rounded-start-pill border-light border-opacity-10"><i class="bi bi-lock-check-fill"></i></span>
                        <input type="password" name="password_confirmation" class="form-control border-0 bg-secondary bg-opacity-10 text-body rounded-end-pill border-light border-opacity-10" required placeholder="••••••••">
                    </div>
                </div>
                ...
                <button type="submit" class="btn btn-primary w-100 py-2 fw-bold shadow-sm rounded-pill transform-hover hover-scale btn-gradient-primary border-0">
                    Restablecer Contraseña <i class="bi bi-check-circle-fill ms-1"></i>
                </button>
            </form>
        </div>
    </div>
