        ...
        <div class="col-lg-8">
            <div class="glass-card overflow-hidden">
                <div class="card-header bg-transparent border-bottom border-light border-opacity-25 py-3 d-flex justify-content-between align-items-center">
                    <h5 class="mb-0 fw-bold text-body"><i class="bi bi-pencil-square me-2"></i>Editar Proveedor</h5>
                ...
                <div class="card-body p-4">
                    <form method="POST" action="{{ route('proveedores.update',$proveedor) }}" id="formProveedor" novalidate class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control rounded-pill bg-secondary bg-opacity-10 border-0 text-body" name="nombre_empresa" id="nombre_empresa" value="{{ old('nombre_empresa',$proveedor->nombre_empresa) }}" required>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control rounded-pill bg-secondary bg-opacity-10 border-0 text-body" name="nit" id="nit" value="{{ old('nit',$proveedor->nit) }}" required pattern="[0-9\-\.]+" title="Solo números, guiones y puntos">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control rounded-pill bg-secondary bg-opacity-10 border-0 text-body" name="contacto" id="contacto" value="{{ old('contacto',$proveedor->contacto) }}">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="tel" class="form-control rounded-pill bg-secondary bg-opacity-10 border-0 text-body" name="telefono" id="telefono" value="{{ old('telefono',$proveedor->telefono) }}" pattern="[0-9+\-\s]+">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control rounded-pill bg-secondary bg-opacity-10 border-0 text-body" name="direccion" id="direccion" value="{{ old('direccion',$proveedor->direccion) }}">
                            @error('direccion')<div class="text-danger small ms-2 mt-1">{{ $message }}</div>@enderror
                        </div>
                        <div class="col-md-6">
                            <label class="form-label fw-bold small text-muted">Email</label>
                            <input type="email" class="form-control rounded-pill bg-secondary bg-opacity-10 border-0 text-body" name="email" id="email" value="{{ old('email',$proveedor->email) }}">
                        ...
                        <div class="col-md-6">
                            ...
                            <select class="form-select rounded-pill bg-secondary bg-opacity-10 border-0 text-body" name="estado" required>
                                <option value="activo" class="bg-dark text-body" @if($proveedor->estado==='activo') selected @endif>Activo</option>
                                <option value="inactivo" class="bg-dark text-body" @if($proveedor->estado==='inactivo') selected @endif>Inactivo</option>
                            </select>
                        </div>
