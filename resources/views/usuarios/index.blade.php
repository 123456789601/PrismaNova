...
<div class="container-fluid py-4">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h4 class="fw-bold mb-1 text-body"><i class="bi bi-people-fill me-2"></i>Usuarios</h4>
                ...
                <table class="table table-hover align-middle mb-0" style="color: #e0e0e0;">
                    ...
                    <tbody>
                        ...
                        <tr class="hover-bg-white-10 transition-all">
                            <td class="ps-4 fw-bold text-muted border-bottom border-light border-opacity-10">#{{ $u->id_usuario }}</td>
                            <td class="border-bottom border-light border-opacity-10">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div>
                                        <div class="fw-bold text-body">{{ $u->nombre }} {{ $u->apellido }}</div>
                                    </div>
                                </div>
                            </td>
                            <td class="text-muted border-bottom border-light border-opacity-10">{{ $u->email }}</td>
                            <td class="border-bottom border-light border-opacity-10">
                            ...
                            <td class="border-bottom border-light border-opacity-10">
                                ...
                                @else
                                    <span class="badge bg-secondary bg-opacity-10 text-muted rounded-pill px-3 border border-secondary border-opacity-25">{{ $u->estado }}</span>
                                @endif
                            </td>
