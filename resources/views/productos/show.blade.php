        ...
        <div class="col-xl-10">
            <div class="glass-card overflow-hidden">
                <div class="card-header bg-transparent border-bottom border-light border-opacity-10 py-3 d-flex justify-content-between align-items-center">
                    <h5 class="mb-0 fw-bold text-body"><i class="bi bi-box-seam me-2 text-primary"></i>Detalle de Producto #{{ $producto->id_producto }}</h5>
                    ...
                    <div class="row g-4">
                        <div class="col-md-4 text-center">
                            ...
                            <div class="d-grid gap-2">
                                <span class="badge rounded-pill py-2 {{ $producto->estado == 'ACTIVO' ? 'bg-success bg-opacity-10 text-success border border-success border-opacity-25' : 'bg-secondary bg-opacity-10 text-muted border border-light border-opacity-10' }}">
                        ...
                        <div class="col-md-8">
                            <h2 class="fw-bold text-body mb-1">{{ $producto->nombre }}</h2>
                            <p class="text-muted mb-4"><i class="bi bi-upc-scan me-2"></i>{{ $producto->codigo_barras }}</p>

                            <div class="row g-3">
                                <div class="col-md-6">
                                    <div class="p-3 bg-secondary bg-opacity-10 rounded-4 border border-light border-opacity-10 h-100 transform-hover">
                                        <label class="small text-muted text-uppercase fw-bold mb-1">Categoría</label>
                                        <p class="fw-bold text-body mb-0 h5"><i class="bi bi-tag me-2 text-primary"></i>{{ $producto->categoria->nombre ?? '-' }}</p>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="p-3 bg-secondary bg-opacity-10 rounded-4 border border-light border-opacity-10 h-100 transform-hover">
                                        <label class="small text-muted text-uppercase fw-bold mb-1">Proveedor</label>
                                        <p class="fw-bold text-body mb-0 h5"><i class="bi bi-building me-2 text-primary"></i>{{ $producto->proveedor->nombre_empresa ?? '-' }}</p>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="p-3 bg-secondary bg-opacity-10 rounded-4 border border-light border-opacity-10 h-100 transform-hover">
                                        <label class="small text-muted text-uppercase fw-bold mb-1">Precio Compra</label>
                                        <p class="fw-bold text-body mb-0 h4">{{ $configuracion['moneda'] ?? '$' }} {{ number_format($producto->precio_compra,2) }}</p>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="p-3 bg-secondary bg-opacity-10 rounded-4 border border-light border-opacity-10 h-100 transform-hover">
                                        <label class="small text-muted text-uppercase fw-bold mb-1">Stock Mínimo</label>
                                        <p class="fw-bold text-body mb-0 h4">{{ $producto->stock_minimo }}</p>
                                    </div>
                                </div>
                            </div>
                        </div>
