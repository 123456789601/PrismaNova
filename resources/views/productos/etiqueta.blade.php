        ...
        <div class="col-md-6 col-lg-5">
            <div class="glass-card overflow-hidden">
                <div class="card-header bg-transparent border-bottom border-light border-opacity-10 py-3 d-flex justify-content-between align-items-center d-print-none">
                    <h5 class="mb-0 fw-bold text-body"><i class="bi bi-upc-scan me-2 text-primary"></i>Etiqueta de Producto</h5>
                ...
                <div class="card-body text-center p-5" id="printableArea">
                    <h2 class="fw-bold mb-1 text-body">{{ $producto->nombre }}</h2>
                    <p class="text-muted mb-3 text-uppercase small fw-bold tracking-wide">{{ $producto->categoria->nombre ?? 'General' }}</p>
                    ...
                    <div class="mt-2">
                        <h1 class="fw-bold display-4 text-body">{{ $configuracion['moneda'] ?? '$' }} {{ number_format($producto->precio_venta, 2) }}</h1>
                    </div>
                </div>
