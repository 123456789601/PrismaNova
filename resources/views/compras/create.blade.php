        ...
        <div class="col-xl-11">
            <div class="glass-card overflow-hidden">
                <div class="card-header bg-transparent border-bottom border-light border-opacity-10 py-3 d-flex justify-content-between align-items-center">
                    <h5 class="mb-0 fw-bold text-body"><i class="bi bi-cart-plus me-2 text-primary"></i>Registrar Compra</h5>
                ...
                <div class="card-body p-4">
                    <form method="POST" action="{{ route('compras.store') }}" id="formCompra" novalidate>
                        ...
                        <div class="row g-3 mb-4 p-4 bg-secondary bg-opacity-10 rounded-4 border border-light border-opacity-10">
                            <div class="col-md-4">
                                <label for="id_proveedor" class="form-label fw-bold small text-muted">Proveedor <span class="text-danger">*</span></label>
                                <select class="form-select border-0 rounded-pill bg-secondary bg-opacity-10 text-body" name="id_proveedor" id="id_proveedor" required>
                            ...
                            <div class="col-md-4">
                                <label for="fecha" class="form-label fw-bold small text-muted">Fecha <span class="text-danger">*</span></label>
                                <input type="datetime-local" class="form-control border-0 rounded-pill bg-secondary bg-opacity-10 text-body" name="fecha" id="fecha" value="{{ old('fecha', now()->format('Y-m-d\TH:i')) }}" required>
                            ...
                            <div class="col-md-4">
                                <label for="impuesto" class="form-label fw-bold small text-muted">Impuesto</label>
                                <div class="input-group rounded-pill overflow-hidden">
                                    <span class="input-group-text border-0 ps-3 bg-secondary bg-opacity-10 text-body">{{ $configuracion['moneda'] ?? '$' }} </span>
                                    <input type="number" step="0.01" class="form-control border-0 bg-secondary bg-opacity-10 text-body" name="impuesto" id="impuesto" value="{{ old('impuesto', '0.00') }}" min="0">
                                </div>
                        ...
                        <div class="table-responsive mb-4 rounded-4 overflow-hidden border border-light border-opacity-10">
                            <table class="table table-hover align-middle mb-0 text-body" id="items">
                                ...
                                <tbody class="border-top-0">
                                    <tr class="hover-bg-white-10 border-bottom border-light border-opacity-10">
                                        <td class="ps-4">
                                            <select class="form-select rounded-pill bg-secondary bg-opacity-10 text-body border-0" name="id_producto[]" required>
                                        ...
                                        <td>
                                            <input type="number" class="form-control rounded-pill bg-secondary bg-opacity-10 text-body border-0" name="cantidad[]" value="1" min="1" required>
                                        </td>
                                        <td>
                                            <div class="input-group">
                                                <span class="input-group-text rounded-start-pill bg-secondary bg-opacity-10 text-body border-0">{{ $configuracion['moneda'] ?? '$' }} </span>
                                                <input type="number" step="0.01" class="form-control rounded-end-pill border-0 bg-secondary bg-opacity-10 text-body" name="precio_compra[]" value="0.00" min="0" required>
                                            </div>
                                        </td>
