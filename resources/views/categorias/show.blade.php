        ...
        <div class="col-xl-8">
            <div class="glass-card overflow-hidden">
                <div class="card-header bg-transparent border-bottom border-light border-opacity-10 py-3 d-flex justify-content-between align-items-center">
                    <h5 class="mb-0 fw-bold text-body"><i class="bi bi-tag me-2 text-primary"></i>Detalle de Categoría</h5>
                ...
                <div class="card-body p-4">
                    <div class="row g-4">
                        <div class="col-md-12 text-center mb-2">
                            ...
                            <h4 class="fw-bold text-body mb-0">{{ $categoria->nombre }}</h4>
                        ...
                        <div class="col-md-12">
                            <div class="p-3 bg-secondary bg-opacity-10 rounded-4 border border-light border-opacity-10 h-100 hover-scale transition-all">
                                <label class="small text-muted text-uppercase fw-bold mb-1">Descripción</label>
                                <p class="fw-bold text-body mb-0">{{ $categoria->descripcion ?: 'Sin descripción' }}</p>
                            </div>
                        </div>
                    </div>
                </div>
