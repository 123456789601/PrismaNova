...
<div class="container-fluid py-4">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h4 class="fw-bold mb-1 text-body"><i class="bi bi-tags-fill me-2"></i>Categorías</h4>
            <p class="text-muted small mb-0">Gestión de categorías de productos</p>
        </div>
                ...
                <table class="table align-middle mb-0 text-body">
                    ...
                    <tbody class="border-top-0">
                        ...
                        <tr class="hover-bg-white-10 transition-all">
                            <td class="ps-4 fw-bold text-muted border-bottom border-light border-opacity-10">#{{ $c->id_categoria }}</td>
                            <td class="border-bottom border-light border-opacity-10">
                                <div class="d-flex align-items-center">
                                    <div class="avatar-sm bg-secondary bg-opacity-10 rounded-circle text-body me-2 d-flex align-items-center justify-content-center shadow-sm" style="width: 32px; height: 32px;">
                                        <i class="bi bi-tag"></i>
                                    </div>
                                    <span class="fw-bold text-body">{{ $c->nombre }}</span>
                                </div>
                            </td>
                            <td class="border-bottom border-light border-opacity-10">
                                @if($c->estado == 'ACTIVO')
                                ...
                                @else
                                    <span class="badge bg-secondary bg-opacity-10 text-muted rounded-pill px-3 border border-secondary border-opacity-25">{{ $c->estado }}</span>
                                @endif
                            </td>
