                ...
                <div class="col-md-4">
                    <div class="glass-card overflow-hidden h-100">
                        <div class="card-header bg-primary bg-opacity-10 border-bottom border-light border-opacity-10 py-3">
                            <h5 class="mb-0 fw-bold text-body"><i class="bi bi-info-circle me-2"></i>Información</h5>
                        </div>
                        <div class="card-body p-4">
                            <div class="mb-4">
                                <label class="small text-muted fw-bold text-uppercase mb-1">Apertura</label>
                                <p class="h5 fw-bold text-body"><i class="bi bi-calendar-check me-2 text-primary"></i>{{ $caja->fecha_apertura }}</p>
                            </div>
                            <div class="mb-4">
                                <label class="small text-muted fw-bold text-uppercase mb-1">Estado</label>
                                <div>
                            ...
                            <div class="mb-4">
                                <label class="small text-muted fw-bold text-uppercase mb-1">Monto Inicial</label>
                            ...
                            <div class="mb-4">
                                <label class="small text-muted fw-bold text-uppercase mb-1">Monto Final</label>
                ...
                <div class="col-md-8">
                    <div class="glass-card overflow-hidden h-100">
                        <div class="card-header bg-primary bg-opacity-10 border-bottom border-light border-opacity-10 py-3 d-flex justify-content-between align-items-center">
                            <h5 class="mb-0 fw-bold text-body"><i class="bi bi-list-check me-2"></i>Movimientos</h5>
                        </div>
                            ...
                            <div class="p-4 bg-secondary bg-opacity-10 border-bottom border-light border-opacity-10">
                                <form method="POST" action="{{ route('caja.movimiento.store',$caja) }}">
                                    ...
                                    <div class="row g-3 align-items-end">
                                        <div class="col-md-3">
                                            <label class="form-label small text-muted text-uppercase fw-bold">Tipo</label>
                                            <select class="form-select rounded-pill border-0 shadow-sm bg-secondary bg-opacity-10 text-body" name="tipo">
                                                <option value="ingreso" class="text-dark">Ingreso (+)</option>
                                                <option value="egreso" class="text-dark">Egreso (-)</option>
                                            </select>
                                        </div>
                                        <div class="col-md-3">
                                            <label class="form-label small text-muted text-uppercase fw-bold">Monto</label>
                                            <div class="input-group rounded-pill overflow-hidden shadow-sm">
                                                <span class="input-group-text border-0 bg-secondary bg-opacity-10 text-body ps-3">{{ $configuracion['moneda'] ?? '$' }} </span>
                                                <input type="number" step="0.01" name="monto" class="form-control border-0 bg-secondary bg-opacity-10 text-body placeholder-gray-400" placeholder="0.00" required>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <label class="form-label small text-muted text-uppercase fw-bold">Descripción</label>
                                            <input name="descripcion" class="form-control rounded-pill border-0 shadow-sm bg-secondary bg-opacity-10 text-body placeholder-gray-400" placeholder="Detalle del movimiento">
                                        </div>
                                        <div class="col-md-2">
                                ...
                                <table class="table table-hover align-middle mb-0 text-body">
                                    ...
                                    <tbody class="border-top-0">
                                        ...
                                        <tr class="hover-bg-white-10 border-bottom border-light border-opacity-10">
                                            <td class="ps-4 text-muted small fw-medium">{{ \Carbon\Carbon::parse($m->fecha)->format('d/m/Y H:i') }}</td>
                                            <td>
                                            ...
                                            <td class="text-body ps-4">{{ $m->descripcion }}</td>
                                        </tr>
                                        @empty
                                        <tr>
